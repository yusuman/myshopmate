package com.haerter.application.views.vorratsliste;

import com.haerter.application.views.MainLayout;
...
@PageTitle("Vorratsliste")
@Route(value = "", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class VorratslisteView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public VorratslisteView() {
        addClassName("vorratsliste-view");
        setSizeFull();
        grid.setHeight("100%");
