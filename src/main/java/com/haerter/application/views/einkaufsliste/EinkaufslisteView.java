package com.haerter.application.views.einkaufsliste;
...
public class EinkaufslisteView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public EinkaufslisteView() {
        addClassName("einkaufsliste-view");
        setSizeFull();
        grid.setHeight("100%");
